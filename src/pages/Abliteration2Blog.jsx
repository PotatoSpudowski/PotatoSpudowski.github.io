...
study.optimize(objective, n_trials=40)
        ...
        <section className="blog-section">
          ...
          <p className="blog-p"><strong>the capability check.</strong> five arithmetic questions, one code question, and one multi-step reasoning question on the final model. the check catches destroyed models. the destroyed models from the direction method passed the refusal test with 0 percent and failed arithmetic and reasoning. the KL metric caught them too. both guards are necessary.</p>
        </section>
