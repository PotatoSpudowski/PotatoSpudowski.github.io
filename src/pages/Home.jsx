      ...
      <section className="hero">
        ...
        <div className="hero-text">
          ...
          <p className="hero-subtitle">
            started in 10th grade writing VBS scripts to mess with school computers. decided ML was more interesting. made 5 figures freelancing during college. operators that needed EOL prediction and hydroflushing cycle optimization pipelines. IBM Research before graduating. founding engineer at a YC startup. MLOps for millions of users at QuillBot. twice at Entrepreneurs First.
          </p>
          <p className="hero-subtitle">
