    ...
    <main className="main blog-main">
      ...
      <div className="blog-body">
        ...
        <section className="blog-section">
          ...
          <p className="blog-p">the more you achieve the more people will look down on you. the more you prove them wrong the more they will hate you for it. they will make it harder, not easier, the further you go.</p>
